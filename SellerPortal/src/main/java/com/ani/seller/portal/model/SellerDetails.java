package com.ani.seller.portal.model;
...
public class SellerDetails {
	...
	public SellerDetails(Long sellerId, @NotBlank String firstName, @NotBlank String lastName,
	...
	public String toString() {
		return "SellerDetails [sellerId=" + sellerId + ", firstName=" + firstName + ", lastName=" + lastName
